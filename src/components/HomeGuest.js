        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input onChange={(e) => dispatch({ type: "usernameImmediately", value: e.target.value })} id="username-register" autoComplete="off" name="username" className="form-control" type="text" placeholder="Pick a username" />
